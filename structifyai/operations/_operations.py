...
def build_documents_delete_request(id: str, **kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/documents/delete/{id}"
...
def build_documents_upload_request(*, content: IO[bytes], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class DatasetOperations:
    ...
    @distributed_trace
    def info(self, *, name: str, **kwargs: Any) -> Optional[Optional[JSON]]:
        ...
        :keyword name: The name of the dataset. Required.
        :paramtype name: str
        :return: JSON object or None or None
        :rtype: JSON or None or None
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        cls: ClsType[Optional[Optional[JSON]]] = kwargs.pop("cls", None)
...
class DocumentsOperations:
    ...
    @distributed_trace
    def upload(self, data: IO[bytes], **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
