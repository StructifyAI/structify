...
def build_dataset_addsource_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    # Construct URL
    _url = "/dataset/add_source"
...
def build_documents_download_request(id: int, **kwargs: Any) -> HttpRequest:
    # Construct URL
...
def build_documents_upload_request(*, path: str, content: IO[bytes], **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DatasetOperations:
    ...
    @overload
    def addsource(  # pylint: disable=inconsistent-return-statements
        ...
        to pair down the internet to a specific domain or criterium.
    ...
    @distributed_trace
    def addsource(  # pylint: disable=inconsistent-return-statements
        self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any
    ) -> None:
        """Adds a data source to a given dataset.
        ...
        _request = build_dataset_addsource_request(
...
class DocumentsOperations:
    ...
    @distributed_trace
    def download(self, id: int, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    def list(self, **kwargs: Any) -> List[JSON]:
        ...
        Example:
            .. code-block:: python
                ...
                response == [
                    {
                        "hash": "str",  # This is the virtual path that the user sees.
                          Required.
                        "path": "str",  # We store a hash of the contents to prevent
                          duplicates in bucket. Required.
                        "user_id": 0  # The user that uploaded the file. Required.
                    }
                ]
        """
        error_map = {
    ...
    def upload(  # pylint: disable=inconsistent-return-statements
        self, data: IO[bytes], *, path: str, **kwargs: Any
    ) -> None:
