...
class Structify:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype dataset: structifyai.aio.operations.DatasetOperations
    :ivar documents: DocumentsOperations operations
    :vartype documents: structifyai.aio.operations.DocumentsOperations
    :ivar server: ServerOperations operations
    :vartype server: structifyai.aio.operations.ServerOperations
