...
from ...operations._operations import (
    build_dataset_addsource_request,
...
class DatasetOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~structifyai.aio.Structify`'s
    ...
    @overload
    async def addsource(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def view(self, *, dataset_name: str, **kwargs: Any) -> List[JSON]:
        """View a dataset.
...
class DocumentsOperations:
    ...
    @distributed_trace_async
    async def download(self, id: int, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
