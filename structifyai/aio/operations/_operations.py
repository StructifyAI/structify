...
class DatasetOperations:
    ...
    @distributed_trace_async
    async def info(self, *, name: str, **kwargs: Any) -> Optional[Optional[JSON]]:
...
class DocumentsOperations:
    ...
    @distributed_trace_async
    async def list(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def upload(self, data: IO[bytes], **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
