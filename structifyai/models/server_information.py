...
class ServerInformation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerInformation:
        """Create an instance of ServerInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerInformation.parse_obj(obj)

        _obj = ServerInformation.parse_obj({
