...
class Structify:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype dataset: structifyai.operations.DatasetOperations
    :ivar documents: DocumentsOperations operations
    :vartype documents: structifyai.operations.DocumentsOperations
    :ivar server: ServerOperations operations
    :vartype server: structifyai.operations.ServerOperations
