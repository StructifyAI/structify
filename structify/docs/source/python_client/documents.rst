...
.. 
    .. autofunction:: structify.operations.DocumentsOperations.delete
        :no-index:
    .. autofunction:: structify.operations.DocumentsOperations.download
        :no-index:
    .. autofunction:: structify.operations.DocumentsOperations.list
        :no-index:
    .. autofunction:: structify.operations.DocumentsOperations.upload
        :no-index:
